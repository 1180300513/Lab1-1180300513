...
public class TurtleSoupTest {
    ...
    /**
     * Tests calculatePolygonSidesFromAngle and calculateRegularPolygonAngle.
     * */
    @Test
    public void cPSFandcRPATest(){
    	for(int i = 3;i<10000;i++){
    		assertEquals(i, TurtleSoup.calculatePolygonSidesFromAngle(TurtleSoup.calculateRegularPolygonAngle(i)));
    	}
    }
}